...
router.get("/mock-interview/summary", async (req, res) => {
    try {
        ...
        // Cap at totalQuestions to prevent inflation
        const cappedAttempts = validAttempts.slice(0, totalQuestions);

        console.log(`[MOCK SUMMARY] Valid attempts: ${validAttempts.length}, Capped: ${cappedAttempts.length}, Total allowed: ${totalQuestions}`);
