...
// --- VOICE MAPPING ---
// Unified voice map for consistent IDs across providers check
const VOICE_DEFS = {
  // US Voices
  ...
  "uk_male_oliver": { google: "en-GB-Neural2-D", eleven: "jsCqWAovK2LkecY7zXl4", locale: "en-GB" }, // Using valid 11labs ID
...
async function generateElevenLabs(text, voiceDef) {
  ...
  if (!apiKey) throw new Error("Missing ELF_API_KEY"); // Short code for ElevenLabs Error
