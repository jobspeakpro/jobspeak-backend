...
router.post("/practice/answer", async (req, res) => {
    try {
        ...
        // Generate vocabulary suggestions and clearer rewrite
        const vocabulary = generateVocabularySuggestions(answerText || '');
        const clearerRewrite = generateClearerRewrite(questionText, answerText || '', evaluation.score);
