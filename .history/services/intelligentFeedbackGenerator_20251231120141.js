...
const VOCAB_DATA = {
    // COMMUNICATION
    "articulate": { pos: "verb", definition: "To express an idea clearly", example: "I <u>articulated</u> the risks to the stakeholders.", whyItHelps: "Shows clarity of thought" },
    "align": { pos: "verb", definition: "To bring into agreement", example: "I worked to <u>align</u> the team on the new goals.", whyItHelps: "Crucial for teamwork" },
    "negociate": { pos: "verb", definition: "To find a compromise", example: "I <u>negotiated</u> a deadline extension.", whyItHelps: "Demonstrates conflict resolution" },
    "facilitate": { pos: "verb", definition: "To make a process easier", example: "I <u>facilitated</u> the design workshop.", whyItHelps: "Signals leadership" },
    "advocate": { pos: "verb", definition: "To support a cause or person", example: "I <u>advocated</u> for the user's needs.", whyItHelps: "Shows empathy and conviction" },
    "clarify": { pos: "verb", definition: "To make less confusing", example: "I asked questions to <u>clarify</u> the requirements.", whyItHelps: "Prevents costly mistakes" },
    "mediate": { pos: "verb", definition: "To intervene in a dispute", example: "I helped <u>mediate</u> the disagreement.", whyItHelps: "Shows emotional intelligence" },

    // EXECUTION
    "prioritize": { pos: "verb", definition: "To determine what is most important", example: "I <u>prioritized</u> the critical bugs first.", whyItHelps: "Shows time management" },
    "execute": { pos: "verb", definition: "To carry out a plan", example: "I <u>executed</u> the launch strategy.", whyItHelps: "Focuses on results" },
    "coordinate": { pos: "verb", definition: "To organize diverse elements", example: "I <u>coordinated</u> the cross-team effort.", whyItHelps: "Shows organizational skill" },
    "drive": { pos: "verb", definition: "To propel or carry along", example: "I helped <u>drive</u> the project to completion.", whyItHelps: "Demonstrates energy and ownership" },
    "implement": { pos: "verb", definition: "To put into effect", example: "We <u>implemented</u> a new testing protocol.", whyItHelps: "Shows technical capability" },
    "spearhead": { pos: "verb", definition: "To lead a movement or attack", example: "I <u>spearheaded</u> the migration initiative.", whyItHelps: "Strong leadership word" },

    // PROBLEM SOLVING
    "diagnose": { pos: "verb", definition: "To identify the nature of a problem", example: "I <u>diagnosed</u> the root cause of the latency.", whyItHelps: "Shows analytical depth" },
    "troubleshoot": { pos: "verb", definition: "To trace and correct faults", example: "I <u>troubleshot</u> the connection failures.", whyItHelps: "Demonstrates persistence" },
    "investigate": { pos: "verb", definition: "To observe or study by close examination", example: "I <u>investigated</u> the discrepancy in data.", whyItHelps: "Shows thoroughness" },
    "resolve": { pos: "verb", definition: "To find a solution", example: "I <u>resolved</u> the conflict by finding common ground.", whyItHelps: "Focuses on outcomes" },
    "assess": { pos: "verb", definition: "To estimate the nature or quality", example: "I <u>assessed</u> the impact of the delay.", whyItHelps: "Shows strategic thinking" },

    // LEADERSHIP
    "mentor": { pos: "verb", definition: "To advise and train", example: "I <u>mentored</u> two junior engineers.", whyItHelps: "Shows investment in others" },
    "empower": { pos: "verb", definition: "To give power or authority", example: "I <u>empowered</u> the team to make decisions.", whyItHelps: "Good management style" },
    "influence": { pos: "verb", definition: "To have an effect on", example: "I used data to <u>influence</u> the roadmap.", whyItHelps: "Critical for senior roles" },
    "guide": { pos: "verb", definition: "To show the way", example: "I <u>guided</u> the new hires through onboarding.", whyItHelps: "Shows supportiveness" },
    "motivate": { pos: "verb", definition: "To provide a motive", example: "I tried to <u>motivate</u> the team during the crunch.", whyItHelps: "Emotional intelligence" },

    // EFFICIENCY
    "optimize": { pos: "verb", definition: "To make as perfect as effective as possible", example: "I <u>optimized</u> the workflow to save time.", whyItHelps: "Results oriented" },
    "streamline": { pos: "verb", definition: "To make simpler or more efficient", example: "I <u>streamlined</u> the approval process.", whyItHelps: "Process improvement focus" },
    "accelerate": { pos: "verb", definition: "To move faster", example: "We <u>accelerated</u> the release schedule.", whyItHelps: "Shows speed of execution" },
    "enhance": { pos: "verb", definition: "To improve the quality", example: "I <u>enhanced</u> the user documentation.", whyItHelps: "Commitment to quality" },

    // NOUNS (Special Handling)
    "scalability": { pos: "noun", definition: "Ability to handle growth", example: "I focused on <u>scalability</u>.", whyItHelps: "System design focus" },
    "initiative": { pos: "noun", definition: "Power or opportunity to act", example: "I took <u>initiative</u>.", whyItHelps: "Self-starter" },
    "empathy": { pos: "noun", definition: "Understanding others' feelings", example: "I led with <u>empathy</u>.", whyItHelps: "Emotional intelligence" },
    "transparency": { pos: "noun", definition: "Openness and accountability", example: "I valued <u>transparency</u>.", whyItHelps: "Builds trust" }
};
...
export function generateRoleVocabulary(questionText, answerText) {
    ...
    const fullObjects = keys.map(k => {
        ...
        if (!data) return null;
        return {
            word: k.charAt(0).toUpperCase() + k.slice(1), // Capitalize for UI
            ...data
        };
    }).filter(Boolean);
...
export function generateSTARRewrite(questionText, answerText, score, feedback, forcedVocab = null) {
    ...
    // --- CONTEXT-AWARE ASSEMBLY (NO FLUFF) ---
    ...
    if (contextType === 'conflict') {
        ...
        // Default / Challenge
        rewrite = `In a previous role, ${userContext}. I assessed the situation and knew I needed to act. I ${buildActionPhrase(v1)} to get things back on track. I broke the problem down and ${buildResultPhrase(v2)}. By staying focused on the goal, I drove a strong result.`;
    }
