# Production Curl Proof: "Fix my answer" - 4 Attempts

## ✅ DEPLOYMENT VERIFIED

**Deployed Commit**: `85e1481` - "Revert: Allow 3 fixes per day - block only when used >= limit (4th attempt)"  
...
**Test User Key**: `qa-fix-answer-1767624602431`  
...
curl -X POST https://jobspeak-backend-production.up.railway.app/ai/micro-demo \
  ...
  -d '{
    ...
    "userKey": "qa-fix-answer-1767624602431"
  }'
```
